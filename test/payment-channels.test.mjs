...
test("registry exposes built-in cash channels for East African markets", () => {
  ...
  const markets = [
    ...
    { country: "IO", currency: "USD", id: "cash_io_usd" },
    ...
    { country: "TF", currency: "EUR", id: "cash_tf_eur" },
...
test("registry exposes built-in cash channels for Greater Antilles and Western Caribbean markets", () => {
  const registry = createPaymentChannelRegistry();
  const markets = [
    { country: "AW", currency: "AWG", id: "cash_aw_awg" },
    { country: "BB", currency: "BBD", id: "cash_bb_bbd" },
    { country: "BQ", currency: "USD", id: "cash_bq_usd" },
    { country: "BS", currency: "BSD", id: "cash_bs_bsd" },
    { country: "CU", currency: "CUP", id: "cash_cu_cup" },
    { country: "CW", currency: "ANG", id: "cash_cw_ang" },
    { country: "DO", currency: "DOP", id: "cash_do_dop" },
    { country: "HT", currency: "HTG", id: "cash_ht_htg" },
    { country: "JM", currency: "JMD", id: "cash_jm_jmd" },
    { country: "KY", currency: "KYD", id: "cash_ky_kyd" },
    { country: "PR", currency: "USD", id: "cash_pr_usd" },
    { country: "SX", currency: "ANG", id: "cash_sx_ang" },
    { country: "TC", currency: "USD", id: "cash_tc_usd" },
    { country: "TT", currency: "TTD", id: "cash_tt_ttd" },
    { country: "VG", currency: "USD", id: "cash_vg_usd" },
    { country: "VI", currency: "USD", id: "cash_vi_usd" },
  ];

  for (const { country, currency, id } of markets) {
    const channels = listPaymentChannelSchemas(registry, { country, currency, group: PaymentChannelGroup.Cash });
    assert.deepEqual(
      channels.map((channel) => channel.id),
      [id],
    );
...
test("registry exposes built-in cash channels for Western European markets", () => {
  const registry = createPaymentChannelRegistry();
  const markets = [
    { country: "AT", currency: "EUR", id: "cash_at_eur" },
    { country: "BE", currency: "EUR", id: "cash_be_eur" },
    { country: "CH", currency: "CHF", id: "cash_ch_chf" },
    { country: "DE", currency: "EUR", id: "cash_de_eur" },
    { country: "FR", currency: "EUR", id: "cash_fr_eur" },
    { country: "LI", currency: "CHF", id: "cash_li_chf" },
...
test("registry exposes built-in cash channels for Southern European markets", () => {
  const registry = createPaymentChannelRegistry();
  const markets = [
    { country: "AD", currency: "EUR", id: "cash_ad_eur" },
    { country: "AL", currency: "ALL", id: "cash_al_all" },
    { country: "BA", currency: "BAM", id: "cash_ba_bam" },
    { country: "ES", currency: "EUR", id: "cash_es_eur" },
    { country: "GI", currency: "GIP", id: "cash_gi_gip" },
    { country: "GR", currency: "EUR", id: "cash_gr_eur" },
    { country: "HR", currency: "EUR", id: "cash_hr_eur" },
    { country: "IT", currency: "EUR", id: "cash_it_eur" },
    { country: "ME", currency: "EUR", id: "cash_me_eur" },
    { country: "MK", currency: "MKD", id: "cash_mk_mkd" },
    { country: "MT", currency: "EUR", id: "cash_mt_eur" },
    { country: "PT", currency: "EUR", id: "cash_pt_eur" },
    { country: "RS", currency: "RSD", id: "cash_rs_rsd" },
    { country: "SI", currency: "EUR", id: "cash_si_eur" },
    { country: "SM", currency: "EUR", id: "cash_sm_eur" },
    { country: "VA", currency: "EUR", id: "cash_va_eur" },
  ];
...
test("registry exposes built-in cash channels for Eastern European markets", () => {
  const registry = createPaymentChannelRegistry();
  const markets = [
    { country: "BG", currency: "BGN", id: "cash_bg_bgn" },
    { country: "BY", currency: "BYN", id: "cash_by_byn" },
    { country: "CZ", currency: "CZK", id: "cash_cz_czk" },
    { country: "HU", currency: "HUF", id: "cash_hu_huf" },
    { country: "MD", currency: "MDL", id: "cash_md_mdl" },
    { country: "PL", currency: "PLN", id: "cash_pl_pln" },
    { country: "RO", currency: "RON", id: "cash_ro_ron" },
    { country: "RU", currency: "RUB", id: "cash_ru_rub" },
    { country: "SK", currency: "EUR", id: "cash_sk_eur" },
    { country: "UA", currency: "UAH", id: "cash_ua_uah" },
  ];
...
test("registry exposes built-in cash channels for Central Asian markets", () => {
  const registry = createPaymentChannelRegistry();
  const markets = [
    { country: "KG", currency: "KGS", id: "cash_kg_kgs" },
    { country: "KZ", currency: "KZT", id: "cash_kz_kzt" },
...
test("registry exposes built-in cash channels for South-eastern Asian markets", () => {
  const registry = createPaymentChannelRegistry();
  const markets = [
    { country: "BN", currency: "BND", id: "cash_bn_bnd" },
    { country: "ID", currency: "IDR", id: "cash_id_idr" },
    { country: "KH", currency: "KHR", id: "cash_kh_khr" },
    { country: "LA", currency: "LAK", id: "cash_la_lak" },
    { country: "MM", currency: "MMK", id: "cash_mm_mmk" },
    { country: "MY", currency: "MYR", id: "cash_my_myr" },
    { country: "PH", currency: "PHP", id: "cash_ph_php" },
    { country: "SG", currency: "SGD", id: "cash_sg_sgd" },
    { country: "TH", currency: "THB", id: "cash_th_thb" },
    { country: "TL", currency: "USD", id: "cash_tl_usd" },
    { country: "VN", currency: "VND", id: "cash_vn_vnd" },
  ];
...
test("registry exposes built-in cash channels for Southern Asian markets", () => {
  const registry = createPaymentChannelRegistry();
  const markets = [
    { country: "AF", currency: "AFN", id: "cash_af_afn" },
    { country: "BD", currency: "BDT", id: "cash_bd_bdt" },
    { country: "BT", currency: "BTN", id: "cash_bt_btn" },
    { country: "IN", currency: "INR", id: "cash_in_inr" },
    { country: "IR", currency: "IRR", id: "cash_ir_irr" },
    { country: "LK", currency: "LKR", id: "cash_lk_lkr" },
    { country: "MV", currency: "MVR", id: "cash_mv_mvr" },
    { country: "NP", currency: "NPR", id: "cash_np_npr" },
    { country: "PK", currency: "PKR", id: "cash_pk_pkr" },
  ];
...
test("registry exposes built-in cash channels for Western Asian markets", () => {
  const registry = createPaymentChannelRegistry();
  const markets = [
    { country: "AE", currency: "AED", id: "cash_ae_aed" },
    { country: "AM", currency: "AMD", id: "cash_am_amd" },
    { country: "AZ", currency: "AZN", id: "cash_az_azn" },
    { country: "BH", currency: "BHD", id: "cash_bh_bhd" },
    { country: "CY", currency: "EUR", id: "cash_cy_eur" },
    { country: "GE", currency: "GEL", id: "cash_ge_gel" },
    { country: "IL", currency: "ILS", id: "cash_il_ils" },
    { country: "IQ", currency: "IQD", id: "cash_iq_iqd" },
    { country: "JO", currency: "JOD", id: "cash_jo_jod" },
    { country: "KW", currency: "KWD", id: "cash_kw_kwd" },
    { country: "LB", currency: "LBP", id: "cash_lb_lbp" },
    { country: "OM", currency: "OMR", id: "cash_om_omr" },
    { country: "PS", currency: "ILS", id: "cash_ps_ils" },
    { country: "QA", currency: "QAR", id: "cash_qa_qar" },
    { country: "SA", currency: "SAR", id: "cash_sa_sar" },
    { country: "SY", currency: "SYP", id: "cash_sy_syp" },
    { country: "TR", currency: "TRY", id: "cash_tr_try" },
    { country: "YE", currency: "YER", id: "cash_ye_yer" },
  ];
